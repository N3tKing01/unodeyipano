...
exports.getTime = (format, date) => {
    if (date) {
        return moment(date).tz('Africa/Harare').locale('en').format(format)
    } else {
...
exports.jam = (numer, options = {}) => {
    ...
    let timeZone = options?.timeZone ? options.timeZone : "Africa/Harare"
    let jam = options?.timeZone ? moment(numer).tz(timeZone).format(format) : moment(numer).tz("Africa/Harare").format(format)
