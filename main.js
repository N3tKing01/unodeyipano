...
const timezones = settings.timezone || 'Africa/Harare';
...
// Global settings
/*━━━━━━━━━━━━━━━━━━━━*/
global.packname = settings?.packname || "MIDKING";
global.author = settings?.author || "‎☘🆃︎🅴︎🅻︎🅺︎🅸︎🅽︎🅶︎☘";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'ʟɪɢʜᴛ ᴅᴇsᴋ ᴛᴇᴀᴍ,
            serverMessageId: -1
        }
    }
};
    ...
    handleViewOnceReaction(sock, message)  // ← ongeza hapa
        ...
        if (userMessage) {
            ...
            if (message.message) {
                ...
                // Header — gray
                process.stdout.write(GRAY + '╭━━━━━━━━━━━━━ CRAZY-X Bot ━━━━━━━━━━━━━━◆' + RESET + '\n');
