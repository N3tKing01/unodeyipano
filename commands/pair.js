        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(
                    `https://june-pair-df7f96eab817.herokuapp.com/code?number=${number}`,
                    { timeout: 20000 }
                );
                ...
                const errorMessage =
                    apiError.message === "Service Unavailable"
                        ? "Isevisi ayitholakali okwamanje Sicela uzame futhi kamuva."
                        : "Yehlulekile ukukhiqiza ikhodi yokubhangqa Sicela uzame futhi kamuva.";
