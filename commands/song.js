    ...
    try {
        ...
        if (!searchQuery) {
            return await sock.sendMessage(chatId, { 
                text: "_Iyiphi ingoma ofuna ukuyilanda?_"
            }, { quoted: fakekontak });
        }
        ...
        if (!videos || videos.length === 0) {
            return await sock.sendMessage(chatId, { 
                text: "Handina kuwana kana song zvayo!"
            }, { quoted: fakekontak });
        }
        ...
        if (!data || !data.status || !data.result?.download_url) {
            return await sock.sendMessage(chatId, { 
                text: "_Yehlulekile ukulanda umsindo ku-API. Sicela uzame futhi kamuva._"
            }, { quoted: fakekontak });
        }
        ...
        await sock.sendMessage(chatId, { 
            text: "_Ukulanda kuhlulekile. Sicela uzame futhi kamuva._"
        }, { quoted: fakekontak });
    }
}
